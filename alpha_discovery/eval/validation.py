...
"""
Walk-forward validation utilities (restored from OLD_VERSION for Phase A).

This module provides simple walk-forward split generation for backtesting-based
